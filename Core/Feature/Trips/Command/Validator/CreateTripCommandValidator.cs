...
namespace Core.Feature.Trips.Command.Validator
{
    public  class CreateTripCommandValidator:AbstractValidator<CreateTripCommand>
    {
        ...
        public CreateTripCommandValidator( ITripeServices services)
        {
            _services = services;
        ...
        public void Apply()
        {
            ...
            {
                var driverConflict = await _services.DriverTripConflict(command.DriverId, command.DepartualTime, command.ArrivalTime);
                var busConflict = await _services.BusTripConflict(command.BusId, command.DepartualTime, command.ArrivalTime);
