        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicenceNumber = table.Column<string>(type: "nvarchar(5)", maxLength: 5, nullable: false),
                    LicenceExprireYear = table.Column<DateOnly>(type: "date", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Driver_LicenceNumber1", "LicenceNumber Like ' DR-[0-9][0-9][0-9][0-9]'");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Driver_LicenceNumber", "LicenceNumber Like ' DR-[0-9][0-9][0-9][0-9]'");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArrivalOffset = table.Column<TimeSpan>(type: "time", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DepartualTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitude = table.Column<decimal>(type: "decimal(10,7)", precision: 10, scale: 7, nullable: false),
                    Longitude = table.Column<decimal>(type: "decimal(10,7)", precision: 10, scale: 7, nullable: false),
                    SpeedKph = table.Column<decimal>(type: "decimal(8,2)", precision: 8, scale: 2, nullable: false),
                    RecordedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusLocation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BusLocation_Trips_TripId",
                        column: x => x.TripId,
                        principalTable: "Trips",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Reviews_Rating", "[Rate] BETWEEN 1 AND 5");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatsId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BookingSeats_Seats_SeatsId",
                        column: x => x.SeatsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMethos = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingSeats_BookingId_SeatsId",
                table: "BookingSeats",
                columns: new[] { "BookingId", "SeatsId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusLocation_TripId_RecordedAt",
                table: "BusLocation",
                columns: new[] { "TripId", "RecordedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_DriverApplications_LicenceNumber",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_UserId_DriverId",
                table: "Reviews",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RouteStations_RoutesId",
                table: "RouteStations",
                column: "RoutesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_Number_BusId",
                table: "Seats",
                columns: new[] { "Number", "BusId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_DepartualTime",
                table: "Trips",
                column: "DepartualTime");
